...
var CommentsService = function () {
    ...
    var CommentsService = _classThis = /** @class */ (function () {
        function CommentsService_1(supabaseService) {
            this.supabaseService = supabaseService;
        }
        CommentsService_1.prototype.createComment = function (postId, userId, createCommentDto) {
            return __awaiter(this, void 0, void 0, function () {
                var post, _a, comment, error;
        ...
        CommentsService_1.prototype.getPostComments = function (postId) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, comments, error;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, this.supabaseService.getClient()
                                .from('comments')
        ...
        CommentsService_1.prototype.createTaskComment = function (taskId, userId, createCommentDto) {
            return __awaiter(this, void 0, void 0, function () {
                var task, _a, comment, error;
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        case 0: return [4 /*yield*/, this.supabaseService.getClient()
                                .from('tasks')
        ...
        CommentsService_1.prototype.getTaskComments = function (taskId) {
            return __awaiter(this, void 0, void 0, function () {
                var _a, comments, error;
                return __generator(this, function (_b) {
                    switch (_b.label) {
