                    ...
                    <AlertDialog>
                        ...
                        <AlertDialogContent className='w-[300px]'>
                            <AlertDialogHeader className='items-center justify-center'>
                                <Image src="/assets/images/otp-succes.png" alt="succes" width={100} height={100} />
                            ...
                            <AlertDialogFooter className='justify-center items-center'>
                                <AlertDialogAction onClick={() => router.push('/login/forgotpassword/n-pass')}>Oke</AlertDialogAction>
                            </AlertDialogFooter>
                        </AlertDialogContent>
                    </AlertDialog>
                </Button>
                <Button className='w-full bg-transparent text-Neutral-900 hover:bg-transparent hover:text-black-600' onClick={() => router.push('/login')} > <Image src="/assets/images/arrow-left.png" alt="arrow-left" width={20} height={20} /> Back to Login</Button>
            </CardFooter>
        </Card>
    )
}
