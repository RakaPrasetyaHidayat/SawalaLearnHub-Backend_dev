...
import { fetchMembers, Member } from "@/services/userService";
...
export default function MembersPageClient() {
  ...
  const filteredMembers = members.filter((member) => {
    ...
    return (
      username.includes(loweredQuery) ||
      division.includes(loweredQuery) ||
      school.includes(loweredQuery)
    );
  });

  const handleViewProfile = (memberId: number | string) => {
